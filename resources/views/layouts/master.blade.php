            ...
            <ul class="navbar-nav" style="width:100%">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <button class="dropdown-item" type="button">Modul Belajar</button>
                        <button class="dropdown-item" type="button">Forum Diskusi</button>
                        <button class="dropdown-item" type="button">Beasiswa Bootcamp</button>
                        <button class="dropdown-item" type="button">Dashboard Guru</button>
                    </div>
                </li>
                <li class="nav-item">
